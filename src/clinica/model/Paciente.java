...
public class Paciente {
    ...
    public Paciente(int id, boolean ativo, String nome, String cpf,
            String dataNascimento, String email, String telefones, String endereco) {
        this.id = id;
        this.ativo = ativo;
        this.nome = nome;
        this.cpf = cpf;
    ...
    public void setTelefones(String t) {
        this.telefones = t;
    }
